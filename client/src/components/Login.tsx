        ...
        >
          <div className="card-body p-5 ">
            ...
            <img src={'data:image/jpeg;base64,'} className="photo" alt="Helwan University"/>
              ...
              <h2 className="fw-bold mb-2 text-uppercase text-center " style={{ color: '#19355a'}}>Login</h2>
              <p className="text-dark-50 fw-bold mb-5 text-center text-justify"
              style={{
                color: '#19355a',
                marginLeft:'100px'
            }}>
              ...
              <label className="fw-bold form-label text-start" style={{ color: '#19355a'}} htmlFor="username" >
                  Username
                </label>
                ...
                <div className="input-group mb-3">
                    <div className="input-group-prepend">
                      <span className="input-group-text">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="25" fill="currentColor" className="bi bi-person-fill" style={{ color: '#19355a'}} viewBox="0 0 16 16">
              ...
              <div className="form-outline form-white mb-4">
              <label className="fw-bold form-label" style={{ color: '#19355a'}} htmlFor="password">
                  Password
                </label>
                ...
                <div className="input-group mb-3">
                    <div className="input-group-prepend">
                      <span className="input-group-text">
                      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="25" fill="currentColor" className="bi bi-lock-fill"
                      style={{ color: '#19355a'}} viewBox="0 0 16 16">
              ...
              <div className="text-center">
              <button
                className="btn btn-btn-outline-light btn-outline-light btn-lg px-5 fw-bold "
                type="submit"
