        ...
        <form className="ai-form" onSubmit={handleSubmit}>
          <div className="ai-row">
            <div className="ai-form-group">
              <label htmlFor="order_number" className="ai-form-label">Order Number</label>
              <input
                className="ai-input"
                type="text"
                id="order_number"
              ...
              />
              {orderNumberWarning && (
                <span className="ad-warning-message-od">{orderNumberWarning}</span>
              )}
            </div>
            <div className="ai-form-group">
            <label htmlFor="supplier_id" className="ai-form-label s-label">Supplier</label>
            <Select 
            className="ai-input"
            id="suppliersdropdownmenu"
            options={supplieroptions}
            value={supplieroptions.find(option => option.value === supplier_id)}
          ...
          {medicinesData.map((medicine,index) =>(
            <div key={index} className="ai-row" >
              <div className="ai-form-group">
                <label htmlFor="medicine_id" className="ai-form-label mn-label">Medicine Name</label>
              ...
              <div className="ai-form-group">
                <label htmlFor="quantity" className="ai-form-label q-label">Quantity</label>
                <input
              ...
              <div className="ai-form-group">
                <label htmlFor="discount" className="ai-form-label d-label">Discount</label>
                <input
              ...
              <div className="ai-form-group">
                <label htmlFor="price" className="ai-form-label p-label">Price</label>
                <input
              ...
              <div className="ai-form-group">
                <label htmlFor="amount" className="ai-form-label a-label">Amount</label>
                <input
              ...
              <label htmlFor="total_amount" className="ai-form-label am-label">Total Amount</label>
              <input className="ai-input total-amount" type="number"
              value={totalAmount}
               id="total_amount" disabled />
            </div>

          
          <button type="submit" className="addinvoicebtn">
            <b>Add Invoice</b>
          </button>
          <div className="ai-form-group c-group">
            <label htmlFor="comments" className="ai-form-label comments">Comments</label>
            <textarea className="ai-input c-textarea" rows="4" 
            id="comments"
