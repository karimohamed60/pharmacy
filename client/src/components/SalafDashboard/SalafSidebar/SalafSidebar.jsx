...
import "./SalafSidebar.css";
import items from "../../../data/SideBarforSalaf.json";
import LogoutButton from "../../../auth/LogoutButton";
import SalafSidebarItem from "./SalafSidebarItem";
    ...
    >
      {
        <>
          ...
          {items.map((item, index) => (
            <SalafSidebarItem key={index} item={item} />
          ))}
        </>
      }
      <LogoutButton />
