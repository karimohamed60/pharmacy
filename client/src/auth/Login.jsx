              ...
              >
                <div className="card-body p-5 ">
                  <div className="mb-md-5 mt-md-4 pb-">
                    ...
                    <p id="placeholder"
                      className="text-dark-50 fw-bold mb-5 text-center"
                    ...
                    <div className="form-outline form-white mb-4">
                      ...
                      <div className="input-group mb-3">
                        <div className="input-group-prepend">
                          <span className="input-group-text svguser">
                            <svg id="icon"
